...
print(download_page("https://www.w3schools.com",3))
...
<div class="w3-bar w3-card-2 notranslate" style="padding-left:12px;padding-right:16px;overflow:visible">
  ...
  <a class="w3-bar-item w3-button w3-hide-medium bar-item-hover w3-hide-small w3-padding-24 barex ws-hide-1200" href="https://www.w3schools.com/videos/index.php" title="Video Tutorials">Videos</a>
<!--  <a class="w3-bar-item w3-button w3-hide-medium bar-item-hover w3-hide-small w3-padding-24 barex ws-hide-1080" href="/pro/index.php" title="Pro Subscription">Pro <span class="ribbon-topnav ws-hide-1250">NEW</span></a>  -->
  ...
  <div class="w3-right w3-padding-16 w3-white">
    ...
    <a class="w3-bar-item w3-button w3-right ws-hide-950 w3-hide-small barex ws-yellow ws-hover-yellow gt-btn-top-spaces" style="width: 150px;border-radius: 25px; margin-right: 15px;" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3Schools Spaces">Create Website</a>
    <a class="w3-bar-item w3-button w3-right ws-hide-1200 w3-hide-small barex ws-pink ws-hover-pink gt-btn-top-cert" style="border-radius: 25px; margin-right: 15px;" href="https://shop.w3schools.com/collections/course-catalog" target="_blank" id="cert_navbtn" title="Courses">Get Certified</a>
    <a class="w3-bar-item w3-button w3-right w3-hover-dark-grey ws-hide-900 w3-hide-small ws-hide-1300 barex topnavmain_pro gt-btn-top-pro" style="border-radius: 25px; margin-right: 15px;" href="/pro/index.php" target="_blank" title="Upgrade to Improve Your Learning Experiences">Upgrade</a>    
...
<div class="w3-content" style="max-width:1400px">
 ...
 <div class="w3-col l6 w3-center" style="padding:3%;">
  ...
  <a style="position:relative;overflow:visible;margin-bottom:1px;" href="https://www.w3schools.com/videos/index.php" class="w3-button ws-yellow tut-button ws-yellow-hover" title="HTML video tutorial">Video Tutorial</a><br>
  <a href="/tags/default.asp" class="w3-button w3-block ref-button black-color">HTML Reference</a><br>
  <a href="https://shop.w3schools.com/collections/certifications/products/html-certificate" target="_blank" class="w3-button w3-block ws-pink ref-button ws-pink-hover" title="Add HTML Certification">Get Certified</a><br>
  </div>
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/cssref/index.php" class="w3-button w3-block ref-button black-color">CSS Reference</a><br>
  <a href="https://shop.w3schools.com/collections/certifications/products/css-certificate" target="_blank" class="w3-button w3-block ws-pink ref-button ws-pink-hover" title="Add CSS Certification">Get Certified</a><br>
  </div>
 <div class="w3-col l6" style="padding:3%">
  <div class="w3-hide-small grey-color w3-card-2 w3-round" style="padding:16px;">
  <h3>CSS Example:</h3>
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/jsref/default.asp" class="w3-button w3-block ref-button">JavaScript Reference</a><br>
  <a href="https://shop.w3schools.com/collections/certifications/products/javascript-certificate" target="_blank" class="w3-button w3-block ws-pink ref-button ws-pink-hover" title="Add JavaScript Certification">Get Certified</a><br>
 </div>
 <div class="w3-col l6" style="padding:3%">
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/python/python_reference.asp" class="w3-button ref-button black-color">Python Reference</a><br>
  <a href="https://shop.w3schools.com/collections/certifications/products/python-certificate" target="_blank" class="w3-button w3-block ws-pink ref-button ws-pink-hover" title="Add Python Certification">Get Certified</a><br>
 </div>
 <div class="w3-col l6" style="padding:3%">
  <div class="w3-hide-small w3-card-2 grey-color w3-round" style="padding:16px;">
...
<div class="w3-content" style="max-width:1400px">
 <div class="w3-col l6 w3-center" style="padding:3%">
  ...
  <a href="/sql/sql_ref_keywords.asp" class="w3-button ref-button black-color">SQL Reference</a><br>
  <a href="https://shop.w3schools.com/collections/certifications/products/sql-certificate" target="_blank" class="w3-button w3-block ws-pink ref-button ws-pink-hover" title="Add SQL Certification">Get Certified</a><br>
...
<div class="w3-row ws-black tutbuttons" style="padding-bottom:64px;">
  <div style="max-width:1400px;margin:auto">
    ...
    <div class="w3-col l6 s12 w3-center" style="padding:2% 3%;height:auto;">
      <a href="/c/index.php" title="C Tutorial">
...
<!--
    ...
    <div class="w3-col l3 m6 s12 w3-center" style="padding:2% 3%;">
      <a href="/typescript/index.php" title="TypeScript Tutorial">
        <div class="w3-card-2 w3-round ws-light-green" style="padding:24px">
    ...
    <div class="w3-col l3 m6 s12 w3-center" style="padding:2% 3%;">
      <a href="/django/index.php" title="Django Tutorial">
        <div class="w3-card-2 w3-round ws-turquoise" style="padding:24px">
    ...
    <div class="w3-col l3 m6 s12 w3-center" style="padding:2% 3%;">
      <a href="/mongodb/index.php" title="MongoDB Tutorial">
        <div class="w3-card-2 w3-round ws-pink" style="padding:24px">
    ...
    <div class="w3-col l3 m6 s12 w3-center" style="padding:2% 3%;">
      <a href="/typingspeed/default.asp" title="Graphics Tutorial">
...
<div class="ws-black w3-center" style="background-color:#F3ECEA;color:white;">  
  <div style="background-color:#282A35;opacity:0.98;margin:auto;padding:25px 20px 80px 20px">
    <h1 style="font-size:65px;font-weight:700;">W3Schools Spaces</h1>
    <h3 style="margin-top:35px;">Build your own website with W3Schools Spaces.</h3>
    <br>
    <img src="/pro/pic_spaces_ide.png" style="max-width:1200px;width:100%;margin:auto;" title="Spaces" loading="lazy">
    <img src="how-spaces-works3.png" class="w3-hide-medium w3-hide-small" style="max-width:100%;margin:auto auto 35px auto;" loading="lazy">
    <a href="/spaces/index.html" class="ws-btn tut-button" style="margin-top:16px;font-size:21px;width:300px;padding: 11px 18px;">Get Started Now</a><br>
  </div>
</div>
...
<div class="w3-center ws-light-green" style="background-color:white;color:#000;padding-top:65px;padding-bottom:70px">
  <div class="w3-content w3-padding" style="max-width:1400px">
    ...
    <h4 style="margin-top:35px;">Track your progress with the <strong>free</strong> "My Learning" program here at W3Schools.</h4>
    ...
    <!--<a href="https://my-learning.w3schools.com/" target="_blank">-->
      <img id="img_mylearning" src="myl-green-off.png" style="max-width:100%;margin-top:15px;margin-bottom:5px;" loading="lazy" >
    <!--</a>-->
    <a href="https://my-learning.w3schools.com/" target="_blank" class="ws-btn tut-button" style="margin-top:22px;font-size:20px;width:300px;padding: 11px 18px;" id="myLearningFromDefault">Sign Up for Free</a><br>
  </div>
...
<div class="pro-caption ws-black">
  ...
  <div style="text-align:center;margin:auto">
    <ul style="display:inline-block">
      <li><img src="/spaces/files/check3.db67d31e.svg" style="margin-right:15px;">Browse W3Schools <strong>without ads</strong></li>
      <li><img src="/spaces/files/check3.db67d31e.svg" style="margin-right:15px;">Website hosting (Includes <a href="https://www.w3schools.com/spaces/index.html" target="_blank">Spaces</a> PRO)</li>
      <li><img src="/spaces/files/check3.db67d31e.svg" style="margin-right:15px;">Access to our <a href="https://www.w3schools.com/videos/index.php" target="_blank">HTML Video Tutorial</a></li>
    </ul>
  </div>
  <a href="/pro/index.php" class="ws-btn tut-button" style="margin-top:35px;font-size:20px;width:300px;padding: 11px 18px;" id="proFromDefault">Learn More</a><br>
</div>
...
<div class="w3-row ws-turquoise" style="padding-top:40px;padding-bottom:40px;">
 <div class="w3-col l12 w3-center" style="padding:3%;">
  ...
  <p><a class="w3-button tut-button black-color" href="/codegame/index.html" target="_blank" style="font-size:20px;padding: 11px 18px">Play Game</a></p>
 </div>
</div>
...
<div class="w3-center ws-grey" style="padding:64px 24px 90px 24px">
  ...
  <p><a href="/w3css/w3css_templates.asp" class="w3-button tut-button black-color w3-padding-16 w3-mobile" style="width:50%;font-size:20px;">Browse Templates</a></p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="https://shop.w3schools.com/collections/course-catalog" target="_blank" style="font-size:20px;">Get started</a>
...
<div class="w3-white w3-center w3-content" id="howto_padding">
  ...
  <a href="/howto/default.asp" class="w3-button tut-button ws-black w3-padding-16 w3-mobile vl-howtobtn" style="font-size:20px;">Learn How To</a>
</div>

<footer class="w3-container w3-center w3-padding-32 ws-black">
 <div class="w3-container w3-padding-32">
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="/quiztest/default.asp" style="font-size:17px;margin-top:-9px;margin-top:-9px" title="Quizzes">QUIZZES</a>
   ...
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="https://shop.w3schools.com/collections/course-catalog" target="_blank" style="font-size:17px;margin-left:12px;margin-top:-9px;margin-left:12px" title="Courses and Certificates">CERTIFICATES</a>
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="/pro/index.php" style="font-size:17px;margin-top:-9px;margin-left:12px" title="Upgrade to Improve Your Learning Experiences">UPGRADE</a>
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="/spaces/index.html" target="_blank" style="font-size:17px;margin-top:-9px;margin-left:12px" title="Get Your Own Website With W3schools Spaces">SPACES</a>
   <a class="w3-button w3-white w3-hide-small w3-round w3-hide-medium w3-left" href="https://support.w3schools.com" target="_blank" style="font-size:17px;margin-top:-9px;margin-left:12px" title="Support">SUPPORT</a>
   <a class="w3-button w3-white  w3-round ws-hide-1200 w3-left" href="https://campus.w3schools.com/pages/newsletter" target="_blank" style="font-size:17px;margin-top:-9px;margin-left:12px" title="Join Our Newsletter">NEWSLETTER</a>
   ...
   <a class="w3-button w3-white w3-hide-large w3-round" href="https://support.w3schools.com" style="font-size:16px;margin-bottom:16px;" title="Support" target="_blank">SUPPORT</a>
   ...
   <p class="w3-hide-large"><a class="w3-button w3-white w3-round" target="_blank" href="https://shop.w3schools.com/collections/course-catalog" style="margin:auto;display:block;max-width:300px;font-size:16px;margin-bottom:16px;" title="Courses and Certificates">CERTIFICATES</a></p>
   <p class="w3-hide-large"><a class="w3-button w3-white w3-round" href="/pro/index.php" style="margin:auto;display:block;max-width:300px;font-size:16px;margin-bottom:16px;" title="Upgrade to Improve Your Learning Experiences">UPGRADE</a></p>
   <p class="w3-hide-large"><a class="w3-button w3-white w3-round" target="_blank" href="/spaces/index.html" style="margin:auto;display:block;max-width:300px;font-size:16px;margin-bottom:16px;" title="Get Your Own Website With W3schools Spaces">SPACES</a></p>
   <p class="w3-hide-large"><a class="w3-button w3-white w3-round" href="https://campus.w3schools.com/pages/newsletter" target="_blank" style="margin:auto;display:block;max-width:300px;font-size:16px;margin-bottom:16px;" title="Join Our Newsletter">NEWSLETTER</a></p>
